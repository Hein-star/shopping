                ...
                <div class="col-lg-4 col-10">
                    ...
                    ?>
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <a onclick="return confirm('Are you sure you want to logout?')" class="dropdown-item" href="signout.php">
                                Logout
                            </a>
                        </div>
                    <?php } else { ?>
...
<div id="mySidebar" class="sidebar">
    ...
    <div class="mt-3">
        ...
        <div class="collapse sidebardropdown_container_category mt-3" id="user">
            <a class="dropdown-item" href="">
                Profile
            </a>
            <div class="dropdown-divider"></div>
